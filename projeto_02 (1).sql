...
--
-- Host: 127.0.0.1
-- Tempo de geração: 15-Set-2020 às 00:39
...
INSERT INTO `tb_admin.users` (`id`, `user`, `password`, `img`, `nome`, `cargo`) VALUES
(1, 'admin', 'admin', 'rof.jpg', 'Rodolfo Augusto Rodrigues', 2),
(2, 'devcodardevelopment', 'BgUdBcA5i5GyPsS*QR', '5ea9ada6b8a7e.jpg', 'Alguem', 0);
...
(1, 'Raquel', 'Ótimo serviço! Obrigado a todos', '29/04/2020', 1),
(4, 'Cassio ', 'Sistema show!', '02/05/2020', 0),
(8, 'Hugo Ferreira', 'Muito bom trabalhar com vocês! Obrigado e parabéns pelo serviço!', '24/04/2020', 0),
(9, 'Mirian', 'Top demais!', '08/06/2020', 2);
...
(2, 'Criação de site LandingPage para Snop Vila Santana', 3),
(3, 'hellooooooo', 1),
(4, 'mais serviço aqui22', 2);
...
(5, 'Cadastro 1 ', '5eaae266ac906.jpg', 0);
